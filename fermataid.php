...
echo "<b>ID fermata: ".$idstop."</b></BR>".$ora.", arrivi pianificati nella prossima ora:</BR></BR>";
  ...
  //    $trip_id="0";
    ...
    $risposta =0;
      for ($ii=0;$ii<$c;$ii++)
      {
        ...
        $homepage1 .="Linea 🚌 ".$distanza[$ii]['linea']." previsione arrivo: ⌚ ".$distanza[$ii]['orario']."<br>---------<br>";
        //     $homepage1 .="Linea".$distanza[$ii]['linea']."->".$distanza[$ii]['orario']."\n<br>";
        $risposta++;
      }
      }
      if ($risposta ==0) $homepage1="<b>Non ci sono corse nella prossima ora.</b>";
