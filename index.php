<?php
if (! isset($_SERVER['HTTPS']) AND $_GET['r']=="") {
    $redirect_url = "https://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']."?r=1";
...
console.log(latphp+" "+lonphp+" "+r);
  window.location.href = "http://www.piersoft.it/trasportilecceeu/locator.php?lat="+latphp+"&lon="+lonphp+"&r="+r;
}
</script>
</body>
</html>
